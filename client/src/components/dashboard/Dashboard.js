            ...
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="card card-stats">
                <div className="card-header card-header-warning card-header-icon">
                  ...
                  <p className="card-category">Upload your Files</p>
                ...
                <div className="card-footer">
                  <div className="stats">
                    ...
                    <Link to="javascript:;">Get More Space...</Link>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-6">
              <div className="card card-stats">
                <div className="card-header card-header-success card-header-icon">
                  ...
                  <p className="card-category">Admin can create</p>
                    ...
                    <div className="nav-tabs-wrapper">
                      ...
                      <ul className="nav nav-tabs" data-tabs="tabs">
                        <li className="nav-item">
                          <Link className="nav-link active" to="#profile" data-toggle="tab">
                            <i className="material-icons">bug_report</i> Bugs
                            <div className="ripple-container"></div>
                          </Link>
                        </li>
                        <li className="nav-item">
                          <Link className="nav-link" to="#messages" data-toggle="tab">
                            <i className="material-icons">code</i> Website
                            <div className="ripple-container"></div>
                          </Link>
                        </li>
                        <li className="nav-item">
                          <Link className="nav-link" to="#settings" data-toggle="tab">
                      ...
                      <table className="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>Flooded: One year later, assessing what was lost and what was found when Link ravaging rain swept through metro Detroit
                            </td>
                            <td className="td-actions text-right">
                              <button type="button" rel="tooltip" title="Edit Task" className="btn btn-primary btn-link btn-sm">
                                <i className="material-icons">edit</i>
...
export default Dashboard;
    // <div>
    //   <h1  className='large text-primary'>SeeBiz DashBoard</h1>
    //    <ul>
    //   <li>
    //     <Link to='/uploadscript'>Upload_File</Link>
    //   </li>
